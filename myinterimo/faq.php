...
<div class="container-lg">
    ...
    <section id="chiffres" class="box d-block bg-primary  text-light p-5 my-5">
        <div class="row  row-cols-auto justify-content-center align-items-center">

            <div class="col  col-12 col-md-auto d-flex justify-content-center align-items-center   ">
                <h1 class="count  p-2">
                    <span class="prefix">+</span>
                    <span class="num" data-duration-value="5000" data-value="300">300</span>
            ...
            <div class="col  d-flex justify-content-center align-items-center col-md-auto col-12 ">
                <h1 class="count p-2">
                    ...
                    <span class="num" data-duration-value="10000" data-value="8">8</span>
                    <span class="suffix">K</span>
                </h1>
            ...
            <div class="col  d-flex justify-content-center align-items-center col-md-auto col-12">
                <h1 class="count  m-2">
                    <span class="prefix">+</span>
                    <span class="num" data-duration-value="2500" data-value="15">15</span>
                    <span class="suffix">K</span>
                </h1>
...
<div class="container-lg">
    ...
    <section id="section7" class="justify-content-around align-items-center py-5">
        <div class="row row-cols-auto justify-content-around align-items-center">
            <div class="col col-lg-5 col-md-6 col-sm-12 p-lg-5 justify-content-center ">
                <div class="row  text-center">
                    <h6> MyRestAI</h6>
                </div>
                <div class="row text-md-start text-center">
                    <h1 class="bold-text">Solutions pour les Professionnels de l’immobilier</h1>
                </div>
                <div class="row">
                    <p class="description text-md-start text-center">
                        MyInterimo est une application développée par la société MyRestAI, qui propose des solutions
                        innovantes
                    ...
                    <div class="hstack gap-3 justify-content-center mt-5 mb-2">
                        <div class="col d-flex justify-content-end">
                            <a href="https://play.google.com/store/apps/details?id=com.myrestai.interimo"
                               target="_blank" class="googlePlayButton  ">
...
<footer>
    ...
    <div class="row row-cols-auto align-items-center">
        <div class="col col-sm-6 col-12 justify-content-sm-start justify-content-center">
            <h6 class="text-sm-start text-center m-0 description">
