// noinspection CommaExpressionJS,StatementWithEmptyBodyJS
...
!function (t) {
    ...
    function o(t) {
        for (let o = 1; o < arguments.length; o++) {
            const r = null != arguments[o] ? arguments[o] : {};
    ...
    function c(t, e) {
        const n = e && e.addOn || "", o = e && e.baseFilename || t.license + n, r = e && e.minify ? ".min" : "",
    ...
    function u(t, e) {
        const n = e || ["fa"], o = "." + Array.prototype.join.call(n, ",."), r = t.querySelectorAll(o);
        Array.prototype.forEach.call(r, (function (e) {
            const n = e.getAttribute("title");
            e.setAttribute("aria-hidden", "true");
            const o = !e.nextElementSibling || !e.nextElementSibling.classList.contains("sr-only");
            if (n && o) {
    ...
    function v(t) {
        const e = t.owner;
        let n = e._state, o = e._data;
        const r = t[n], i = t.then;
    ...
    E.prototype = {
        constructor: E, _state: "pending", _then: null, _data: void 0, _handled: !1, then: function (t, e) {
            const n = {owner: this, then: new this.constructor(s), fulfilled: t, rejected: e};
        ...
        return new E((function (e, n) {
            ...
            let c, a = 0;
            for (; a < t.length; a++) (c = t[a]) && "function" == typeof c.then ? c.then(i(a), n) : o[a] = c;
            r || e(o)
        }))
    }, E.race = function (t) {
        ...
        return new E((function (e, n) {
            let o, r = 0;
            for (; r < t.length; r++) (o = t[r]) && "function" == typeof o.then ? o.then(e, n) : e(o)
        }))
    ...
    const _ = "function" == typeof Promise ? Promise : E;

    function F(t, e) {
        const n = e.fetch, o = e.XMLHttpRequest, r = e.token;
        let i = t;
    ...
    function k(t, e) {
        ...
        return t.v4shim.enabled && n.push(new _((function (n, r) {
            ...
            F(c(t, {minify: t.minify.enabled}), e).then((function (t) {
                const r = I(t, o(o({}, e), {}, {id: "fa-main"}));
                n(function (t, e) {
                    const n = e && void 0 !== e.autoFetchSvg ? e.autoFetchSvg : void 0,
    ...
    function I(t, e) {
        const n = document.createElement("SCRIPT"), o = document.createTextNode(t);
    ...
    function L(t) {
        let e;
        const n = [], o = document, r = o.documentElement.doScroll;
        let i = (r ? /^loaded|^c/ : /^loaded|^i|^c/).test(o.readyState);
    ...
    try {
        if (window.FontAwesomeKitConfig) {
            const x = window.FontAwesomeKitConfig, M = {
