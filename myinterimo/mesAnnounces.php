...
<div class="container-lg ">
    <?php if (isset($_SESSION['user']) && !empty($_SESSION['user'])):
        ?>
        <section class="box d-block  mt-5 shadow-sm ">
                        ...
                        <div class="col">
                            <label>
                                <select name="type_immobilier" id="inputType"
                                    ...
                                    <option value="" selected>Tous les type</option>
                                    <option value="appartement">Appartements</option>
                                    <option value="maison">Maisons et Villas</option>
                                    <option value="magasin">Magasin, Commerces ou Locaux industriels</option>
    ...
    <?php else : ?>
        ...
        <section id="section1" class="row justify-content-around align-items-center px-3 pb-5">
        ...
        <section id="box1" class="box justify-content-center align-items-center p-5 my-5">
            <div class="row row-cols-auto  justify-content-around align-items-center">
                <div class="col col-md-4 col-12">
                    <div class="row">
                        <h6 class="primary-text text-md-left text-center">Utilisez MyInterimo avec MyEspaceo et soyez
                            100%
                            connecté !</h6>
            ...
            <div class="col-md-6 col-12 order-md-1">
                ...
                <div class="row">
                    <p class="description">
                        ...
                        international du réseau. Cela va permettre de fluidifier le marché, et à chaque membre d’élargir
                        son
                        panel d’offres.
                        Rendre le marché de l’immobilier plus accessible et transparent pour les acheteurs, c’est aussi
                        la
                    ...
                    <div class="row row-cols-auto ">
                        <div class="col col-md-6 col-sm-12 ">
                            <div class="fonction row row-cols-auto align-items-center justify-content-center">
                                ...
                                <div class="col col-md-12 col-9">
                                    <h6 class="circle-icon-title text-md-start text-center">Des partenariats
                                        maîtrisés</h6>
                                    <p class="description text-md-start text-center">
                                        Vous choisissez avec quels partenaires du marché immobilier, vous souhaitez
                                        travailler et quels mandats vous souhaitez déléguer. Invitez vos partenaires
                                        actuels
                        ...
                        <div class="col col-md-6 col-sm-12">
                            <div class="fonction row row-cols-auto align-items-center justify-content-center">
                                ...
                                <div class="col col-md-12 col-9">
                                    <h6 class="circle-icon-title text-md-start text-center">Offre de biens
                                        démultipliée</h6>
                                    <p class="description text-md-start text-center">
                        ...
                        <div class="col col-md-6 col-sm-12">
                            <div class="fonction row row-cols-auto align-items-center justify-content-center">
                                ...
                                <div class="col col-md-12 col-9">
                                    ...
                                    <p class="description text-md-start text-center">
                                        Imaginez le bouche-à-oreille dont vous allez bénéficier auprès des vendeurs et
                                        des
                                        acheteurs.
                                        Votre
                            ...
                            <div class="fonction row row-cols-auto align-items-center justify-content-center">
                                ...
                                <div class="col col-md-12 col-9">
                                    ...
                                    <p class="description text-md-start text-center">
                                        ...
                                        de
                                        proposer
                                        à vos clients. Les barrières géographiques ou les limites inhérentes à la taille
                                        de
                                        votre
                                        agence
